...
public class EventAdapter extends RecyclerView.Adapter<EventAdapter.EventViewHolder>
{
    ...
    public void onBindViewHolder(@NonNull EventViewHolder holder, final int position)
    {
        ...
        //Toast.makeText(context,"event clicked:"+event.getTitle()+"\nPosition:"+pos,Toast.LENGTH_SHORT).show();
...
//                                                                    {
//
//                                                                        if(event.PDF_URL!=null)
//                                                                        {
//                                                                            StorageReference storageReference = storage.getReferenceFromUrl(event.PDF_URL);
...
//                                                                        }
//                                                                        /*
//                                                                        for(int i=0;i<event.EventMembers.size();i++)
//                                                                        {
//                                                                            deleteMember=event.EventMembers.get(i);
//                                                                            userRef.document(event.EventMembers.get(i)).collection("Events")
//                                                                                    .whereEqualTo("title",event.Title)
//                                                                                    .whereEqualTo("time",event.Time)
//                                                                                    .whereEqualTo("duration",event.Duration)
//                                                                                    .whereEqualTo("location",event.Location)
